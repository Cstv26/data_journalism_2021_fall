...
**Answer**
Uppercase and lowercase variations of the city names.
```{r}
...
**Answer**
It put most of the names in titlecase, as well as filtering it by the starting letter, for this instance, A.
```{r}
...
**Answer**
Put somethings in titlecase, but other than that I dont see anything.
```{r}
cleaned_md_loans %>%
