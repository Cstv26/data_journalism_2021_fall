...
**Answer**
The datafram shows the raw data of vaccinations by county and population. 
```{r}
...
**Answer**
It is the total number of vaccinations per county.
...
**Answer**
This represents the number of vaccinations by date.
...
**Answer**
Not really, the number is kind of either always going up or down. 
```{r}
...
**Answer**
People really got fully vaxxed in the Summer, people still are but at a much lower rate.
```{r fig.width=9}
ggplot() +
...
**Task** Run the following code and put the value of `sub` in the answer.
**Answer**
The number of fully vaxxed people in PG County.
...
**Answer**
The chart shows lines representing each county and the trend of cases.
```{r}
...
**Task** Run the following code and describe what the resulting chart shows
**Answer**
The same as above but more accurate in describing the trend.
```{r}
