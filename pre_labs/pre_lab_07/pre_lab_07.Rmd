...
**Answer**
  I see all the html code that went into making the page. There is an insane amount of div and ul tags. It makes sense as to why since everything is put into a data set or a list but its just crazy how much goes into it.
...
**Answer**
I see an html, body, and head tags along with xlm attributes which ive never seen before.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
I see an absolute mess of html. There is so many div tags with padding and things that I didnt know existed.
### Task 9: Load image
**Task** Run the following code to display an image showing what you should see on the web page.
```{r, echo=FALSE}
...
**Answer**
It shows what I saw in the pervious part of the pre lab.
```{r}
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
It shows a list of rows each containing a list of its own with rows and columns.
...
**Answer**
It opens up the datafram so you can see all of the rows and columns.
### Task 14: Load image
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
It shows all the rows and columns of the second data frame including the row with the source link.
### Task 16: Load image
...
**Answer**
It took out the source list abd merged some columns together.
```{r}
# Read in all html from table, store all tables on page as nested list of dataframes.
naics_industry <- naics_url %>%
  read_html() %>%
...
We can find it here: [https://www.bls.gov/iag/tgs/iag22.htm](view-source:https://www.bls.gov/ces/naics/).

### Task 4: Go to the web page linked above
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
It shows the html make up of the webpage.
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**Answer**
The output is a breif html code with a head and body tag.
```{r}
...
**Answer**
Its more code than before now some of the tages have a t in front of them.
```{r}
...
**Answer**
The output is the data like we have been seeing represented in rows and columns.
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
I see the normal webpage as it is meant to be seen, no html.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
This page of the website is about the construction sector, still no html.
...
**Answer**
The output that appears in the console just describes the list of sectors and nmes some of the columns.
```{r}
...
**Answer**
The produces the list of sectors actually below the codeblock this time.
```{r}
...
**Answer**
There is an error: Error in sector_list : object 'sector_list' not found
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer**
The output is again a list of elements such as construction and agriculture.
```{r}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer**
there is an error: Error in print(sector_name) : object 'sector_name' not found
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Answer**
The sector and description columns.
```{r}
...
**Answer**
All employment of seasonal employees and then the number for June 2021 which was 586.7.
```{r}
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer**
Sectors and descriptions for each code.
```{r}
# Define url of page we want to scrape
...
**Answer**
Sector code, names, as well as the URLS.
```{r}
...
**Answer**
Sector code, names, URLS, as well as the xpaths.
```{r}
...
**Answer**
It has all the same information as before but there is no Public Administration row.
```{r}
...
**Answer**
Each row now has its own table.
```{r}
...
**Answer**
It makes a list of the rows and shows their URLS.
```{r}
...
**Answer**
There are now 18 tables, 1 with 2 rows, 2 with 6 rows, and 15 with 10 rows, all with 6 columns.
```{r}
...
**Answer**
19 tables of 1 row and 10 columns
```{r}
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer**
19 tables of 1 row and 3 columns.
```{r}
...
**Answer**
A single table of 19 rows and 3 columns.
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
An about page of the Oil, Mining, and Gas sector.
### Task 37: Load image
**Task** Run the following code to display an image showing what you should see on the web page.
...
**Answer**
Agriculture is still in the table in the first row.
```{r}
