...
wv_maryland_loans <- read_rds("lab_03.rds") 
...
A1:Charleston with 2837, South Charleston with 484, Saint Albans with 304, Dunbar with 166, and Nitro with 142.
```{r}
...
A2: 
The zip was 25301 and is located in Kanawha county WV. The business was the Jackson Kelly PLLC, the loan was worth $5068472. The forgiveness amount was $5126618.64, this could be due to interest on the loan.
```{r}
# Hint
...
A3:
The business's are owned by Carol Miller's husband Matthew Miller. The businesses are "Dutch Miller" and are auto dealerships. In total the amount of money they recived was $3,105,300. The amount forgiven was $3,140,471.40. 101% of the total loan amount was forgiven. Miller voted in favor of the PPP plan.
```{r}
